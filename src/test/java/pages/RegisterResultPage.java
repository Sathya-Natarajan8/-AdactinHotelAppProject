...
public class RegisterResultPage extends ProjectSpecificationMethods {
    ...
    public boolean isEmailVerificationSuccessful() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement successMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//body[contains(text(),'Thankyou for verifying your email address.')]")));
