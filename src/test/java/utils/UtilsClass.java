...
public class UtilsClass {
	...
	public static String[][] readExcel(String sheetname) throws IOException {
		String filePath = ("C:\\Users\\sathy\\eclipse-workspace\\AdactinHotelWebsite\\src\\test\\resources\\Adactin Hotel Website.xlsx");
	...
	public static String screenshot(String name) {
		...
		try {
			String path = "C:\\Users\\sathy\\eclipse-workspace\\AdactinHotelWebsite\\snap" + name + ".png";
